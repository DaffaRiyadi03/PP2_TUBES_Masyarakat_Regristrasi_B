...
public class HalamanOtpReset extends JPanel {
    ...
    public HalamanOtpReset(MainFrame mainFrame) {
    ...
    private void initComponents() {
        ...
        backButton = new JButton("Back to Forgot Password");
    ...
    private void setupListeners() {
        submitButton.addActionListener(e -> {
            ...
            try {
                ...
                if (email == null || email.isEmpty()) {
                 ...
                 boolean verified = userController.verifyPasswordResetOtp(email, otp);
        ...
        backButton.addActionListener(e -> mainFrame.showLupaPassword());
    }
}